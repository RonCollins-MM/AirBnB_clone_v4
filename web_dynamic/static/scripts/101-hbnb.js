$(function () {
            ...
            for (let place of data) {
                ...
                $('.places').append(
                    `<article>
                        ...
                        <div class="reviews">
						<h2 class="article_subtitle">Reviews - <span id=${"show-review-"+place.id} class="show-review" onclick="$(this).toggleClass('show');$('#review-ul').toggle();$(this).hasClass('show') ? $(this).text('hide'):$(this).text('show');">
                            show
                            </span></h2>
						<ul id=${"review-ul"} style="display: none">
						    <li>
                                <div class="review_item">
                                    <!--<h3>Hello</h3>-->
                                    <p class="review_text">Test Review</p>
                                </div>
                            </li>
						</ul>
					    </div>
            ...
            success: function (data) {
                ...
                if (!data) {
                    ...
                    data.forEach((place) => {
                        ...
                        <div class="reviews">
						<h2 class="article_subtitle">Reviews - <span class="show-review">show</span></h2>
						<ul id="review-ul">
                            <li>
                                <div class="review_item">
                                    <!--<h3>Hello</h3>-->
    ...
    function toggleReview(place_id){
